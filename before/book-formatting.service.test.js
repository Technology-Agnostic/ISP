...
const AUDIO_BOOKS_DATA_KEY = 'audioBooks'
const VIDEO_BOOKS_DATA_KEY = 'videoBooks'

describe('BookFormattingService', () => {
    fetch = () => {
        return {
            [ BOOKS_DATA_KEY ]: BOOKS,
            [ AUDIO_BOOKS_DATA_KEY ]: AUDIO_BOOKS,
            [ VIDEO_BOOKS_DATA_KEY ]: VIDEO_BOOKS
        }
    };
    ...
    const bookRepository = new BookRepository(bookFactory, BOOKS_DATA_KEY);
    const audioBooksRepository = new BookRepository(audioBookFactory, AUDIO_BOOKS_DATA_KEY);
    const videoBooksRepository = new BookRepository(videoBookFactory, VIDEO_BOOKS_DATA_KEY);
