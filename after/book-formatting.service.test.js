...
const BOOKS_DATA_URI = 'example://api.books-storage/books'
const AUDIO_BOOKS_DATA_URI = 'example://api.books-storage/audio-books'
const VIDEO_BOOKS_DATA_URI = 'example://api.books-storage/video-books'
...
describe('BookFormattingService', () => {
    fetch = (uri) => {
        switch (uri) {
            case BOOKS_DATA_URI:
                return BOOKS;
            case AUDIO_BOOKS_DATA_URI:
                return AUDIO_BOOKS;
            case VIDEO_BOOKS_DATA_URI:
                return VIDEO_BOOKS;
        }
    };
    ...
    const bookRepository = new BookRepository(bookFactory, BOOKS_DATA_URI);
    const audioBooksRepository = new BookRepository(audioBookFactory, AUDIO_BOOKS_DATA_URI);
    const videoBooksRepository = new BookRepository(videoBookFactory, VIDEO_BOOKS_DATA_URI);
